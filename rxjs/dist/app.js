...
const inputStream = __WEBPACK_IMPORTED_MODULE_0_rxjs___default.a.Observable.fromEvent($input, 'input').map(e => e.target.value)

var sum = 0;
const clickStream1 = __WEBPACK_IMPORTED_MODULE_0_rxjs___default.a.Observable.fromEvent($btn, 'click')
	.map(() => { 
		sum++
		return '第' + sum + '次点击提交：' 
	})

const clickStream2 = __WEBPACK_IMPORTED_MODULE_0_rxjs___default.a.Observable.fromEvent($btn_merge, 'click')
...
__WEBPACK_IMPORTED_MODULE_0_rxjs___default.a.Observable.range(5, 10).flatMap((item, index) => {
	return Promise.resolve(item)
}).subscribe((x) => console.log('由开始5开始，每次累加1: ', x))

// interval 
__WEBPACK_IMPORTED_MODULE_0_rxjs___default.a.Observable.interval(500).map((x) => x * 2).take(4)
...
__WEBPACK_IMPORTED_MODULE_0_rxjs___default.a.Observable.interval(200).map((index) => arrStream1[index])
	.merge(__WEBPACK_IMPORTED_MODULE_0_rxjs___default.a.Observable.interval(300).map((index) => arrStream2[index])).take(5)
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(66), __webpack_require__(68)))
